...
1) Make the circuit as per the given diagram.
...
2) Connect your Arduino uno with the provided USB cable to your computer.

   * sure that the USB cable is securely connected to both the Arduino uno and your computer.
...
4) Upload the sketch to the Arduino uno by clicking on the Upload button (arrow icon) or pressing Ctrl + U.
